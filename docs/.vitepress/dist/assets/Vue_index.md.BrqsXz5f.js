import{_ as n,c as a,o as p,ag as e}from"./chunks/framework.CPUF7_g-.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Vue/index.md","filePath":"Vue/index.md"}'),l={name:"Vue/index.md"};function t(i,s,o,c,r,d){return p(),a("div",null,s[0]||(s[0]=[e(`<h2 id="基于smatradmin的vue-js后台管理系统" tabindex="-1">基于SmatrAdmin的Vue.js后台管理系统 <a class="header-anchor" href="#基于smatradmin的vue-js后台管理系统" aria-label="Permalink to &quot;基于SmatrAdmin的Vue.js后台管理系统&quot;">​</a></h2><h2 id="项目目录" tabindex="-1">项目目录 <a class="header-anchor" href="#项目目录" aria-label="Permalink to &quot;项目目录&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>src                               源码目录</span></span>
...
<span class="line"><span>|   ├─ system                       系统目录</span></span></code></pre></div><h2 id="不同环境配置和打包" tabindex="-1">不同环境配置和打包 <a class="header-anchor" href="#不同环境配置和打包" aria-label="Permalink to &quot;不同环境配置和打包&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>本地环境（localhost,用于本地开发，连接本地api）</span></span>
...
<span class="line"><span>},</span></span></code></pre></div><h2 id="项目基本配置-types-config-ts-config-app-config-ts" tabindex="-1">项目基本配置 types/config.ts config/app-config.ts <a class="header-anchor" href="#项目基本配置-types-config-ts-config-app-config-ts" aria-label="Permalink to &quot;项目基本配置 types/config.ts config/app-config.ts&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { AppConfig } from &#39;/@/types/config&#39;;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>/**</span></span>
...
<span class="line"><span>};</span></span></code></pre></div><h2 id="项目常用方法-utils文件夹" tabindex="-1">项目常用方法 utils文件夹 <a class="header-anchor" href="#项目常用方法-utils文件夹" aria-label="Permalink to &quot;项目常用方法 utils文件夹&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>框架自带有</span></span>
<span class="line"><span>├─ cookie-util.ts 操作cookie</span></span>
<span class="line"><span>├─ local-util.ts 操作localStorage</span></span>
<span class="line"><span>├─ str-util.ts 字符串操作</span></span></code></pre></div><h2 id="布局" tabindex="-1">布局 <a class="header-anchor" href="#布局" aria-label="Permalink to &quot;布局&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├─ layout/index.vue    菜单</span></span>
...
<span class="line"><span>├─ constants/regular-const.ts 常用正则</span></span></code></pre></div><h2 id="静态资源-assets" tabindex="-1">静态资源 assets <a class="header-anchor" href="#静态资源-assets" aria-label="Permalink to &quot;静态资源  assets&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├─ assets/images 图片资源</span></span></code></pre></div><h2 id="plugins-插件" tabindex="-1">plugins 插件 <a class="header-anchor" href="#plugins-插件" aria-label="Permalink to &quot;plugins 插件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├─ plugins/privilege-plugin.ts 权限插件</span></span>
<span class="line"><span>├─ plugins/smart-enums-plugin.ts 枚举插件</span></span></code></pre></div><h2 id="lib-第三方插件" tabindex="-1">lib 第三方插件 <a class="header-anchor" href="#lib-第三方插件" aria-label="Permalink to &quot;lib 第三方插件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├─ lib/axios.ts 框架自带的封装ajax请求 是否需要改造待定</span></span>
<span class="line"><span>├─ lib/default-time-ranges.ts 时间选择框快捷选择</span></span>
<span class="line"><span>├─ lib/encrypt.ts 加解密</span></span>
<span class="line"><span>├─ lib/smart-wartermark.ts 水印</span></span></code></pre></div><h2 id="网络请求" tabindex="-1">网络请求 <a class="header-anchor" href="#网络请求" aria-label="Permalink to &quot;网络请求&quot;">​</a></h2><ul><li>项目封装了Axios来做网络请求，包括错误处理、取消请求等功能</li><li>接口配置化处理 结合.env 配置文件使用</li></ul><h3 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├─ api</span></span>
...
<span class="line"><span>│  ├─ pending.ts</span></span></code></pre></div><h3 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h3><p>接口地址是通过环境变量加载的，可以通过项目根目录下的.env.***文件中修改VITE_APP_BASE_API，而不是在此处直接修改。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 接口地址</span></span>
...
<span class="line"><span>export const CameraHost = &#39;http://127.0.0.1:38088/&#39;;</span></span></code></pre></div><h3 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h3><p>写一个role列表查询</p><ul><li>api-&gt; 对应模块的文件夹 -&gt;role.ts</li><li>在role.ts中引入封装后的axios</li><li>编写请求函数</li><li>给请求函数的入参和返回值加上TS类型限制</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 方法引入</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="使用api函数" tabindex="-1">使用api函数 <a class="header-anchor" href="#使用api函数" aria-label="Permalink to &quot;使用api函数&quot;">​</a></h3><ul><li>在对应的views页面中引入api函数</li><li>创建对应的model文件，编写对应的class实例和方法</li><li>views页面中引入对应的方法</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>model.ts</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>views页面 根据业务进行具体操作</span></span>
...
<span class="line"><span>});</span></span></code></pre></div><h2 id="组件-components" tabindex="-1">组件 components <a class="header-anchor" href="#组件-components" aria-label="Permalink to &quot;组件 components&quot;">​</a></h2><h2 id="表单组件" tabindex="-1">表单组件 <a class="header-anchor" href="#表单组件" aria-label="Permalink to &quot;表单组件&quot;">​</a></h2><h3 id="文件结构" tabindex="-1">文件结构 <a class="header-anchor" href="#文件结构" aria-label="Permalink to &quot;文件结构&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├─ components</span></span>
...
<span class="line"><span>│  │  └─ index.ts   入口文件</span></span></code></pre></div><h3 id="表单示例" tabindex="-1">表单示例 <a class="header-anchor" href="#表单示例" aria-label="Permalink to &quot;表单示例&quot;">​</a></h3><ul><li></li><li>在module文件夹创建对应表单实例</li><li>引入表单组件</li><li>创建表单实例</li><li>根据业务编写对应的方法</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>module</span></span>
<span class="line"><span>import * as Api from &#39;/@/api&#39;;</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>/* #endregion */</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>views</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    return true;</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>views </span></span>
