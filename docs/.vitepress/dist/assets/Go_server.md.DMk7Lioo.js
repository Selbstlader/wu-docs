import{_ as n,c as s,o as a,a4 as p}from"./chunks/framework.DLF8A2I8.js";const e="/wu-docs/assets/goServer.25YN8DeD.png",l="/wu-docs/assets/goRpc.tSZueQ0g.png",q=JSON.parse('{"title":"微服务特点","description":"","frontmatter":{},"headers":[],"relativePath":"Go/server.md","filePath":"Go/server.md"}'),t={name:"Go/server.md"},i=p('<h2 id="微服务架构" tabindex="-1">微服务架构 <a class="header-anchor" href="#微服务架构" aria-label="Permalink to &quot;微服务架构&quot;">​</a></h2><h1 id="微服务特点" tabindex="-1">微服务特点 <a class="header-anchor" href="#微服务特点" aria-label="Permalink to &quot;微服务特点&quot;">​</a></h1><p>优势 独立性 技术灵活 高效团队</p><p>缺点 服务拆分 增加额外的工作 <img src="'+e+`" alt="Alternative text" title="optional title"></p><h2 id="rpc" tabindex="-1">RPC <a class="header-anchor" href="#rpc" aria-label="Permalink to &quot;RPC&quot;">​</a></h2><p>服务端 server.go</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>业务层 client.go</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import (</span></span>
...
<span class="line"><span>	}</span></span>
<span class="line"><span>	fmt.Println(ret)</span></span>
<span class="line"><span>  }</span></span></code></pre></div><h1 id="rpc的调用流程" tabindex="-1">RPC的调用流程 <a class="header-anchor" href="#rpc的调用流程" aria-label="Permalink to &quot;RPC的调用流程&quot;">​</a></h1><ol><li>GO微服务架构下 数据交互是对内RPC 对外REST 将业务拆分到各个微服务，具有提高项目协助的效率。 <img src="`+l+'" alt="Alternative text" title="optional title"></li></ol>',11),c=[i];function r(o,u,h,d,m,g){return a(),s("div",null,c)}const P=n(t,[["render",r]]);export{q as __pageData,P as default};
