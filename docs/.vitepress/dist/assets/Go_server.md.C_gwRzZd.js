...
<span class="line"><span>	}</span></span>
<span class="line"><span>	fmt.Println(ret)</span></span>
<span class="line"><span>  }</span></span></code></pre></div><h1 id="rpc的调用流程" tabindex="-1">RPC的调用流程 <a class="header-anchor" href="#rpc的调用流程" aria-label="Permalink to &quot;RPC的调用流程&quot;">​</a></h1><p>GO微服务架构下 数据交互是对内RPC 对外REST 将业务拆分到各个微服务，具有提高项目协助的效率。 <img src="`+t+'" alt="Alternative text" title="optional title"></p>',11),c=[i];function r(o,u,h,d,m,g){return a(),s("div",null,c)}const P=n(l,[["render",r]]);export{q as __pageData,P as default};
