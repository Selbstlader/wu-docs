...
<span class="line"><span>    });</span></span>
<span class="line"><span>  });</span></span></code></pre></div><h2 id="_5-安装electron打包工具" tabindex="-1">5. 安装electron打包工具 <a class="header-anchor" href="#_5-安装electron打包工具" aria-label="Permalink to &quot;5. 安装electron打包工具&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm install electron-packager -g</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>  {</span></span>
...
<span class="line"><span>    &quot;packager&quot;:&quot;electron-packager ./ ISCS --platform=win32 --arch=x64 --electron-version=1.8.4 --out --overwrite&quot; //新增</span></span>
<span class="line"><span>  },</span></span>
...
<span class="line"><span>   }</span></span>
<span class="line"><span>  }</span></span></code></pre></div><p>每一个属性说明： ./表示当前路径 ISCS ：exe应用的名称 platform: 打包平台 darwin, linux, mas, win32或者选择all arch: 可选 ia32, x64, armv7l, arm64或者选择all electron-version： electron的版本（） out：生成的exe保存目录 overwrite:添加此属性在每次打包可以直接覆盖原来的exe文件了。</p><h2 id="打包" tabindex="-1">打包 <a class="header-anchor" href="#打包" aria-label="Permalink to &quot;打包&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm run-script packager</span></span></code></pre></div>`,14),t=[l];function o(i,c,r,u,d,h){return s(),a("div",null,t)}const b=n(p,[["render",o]]);export{q as __pageData,b as default};
